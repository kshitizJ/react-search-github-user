...
const Search = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // console.log(user);
        // if there is user name in input field then submit the username else if user is empty string then do nothing
        if (user) {
            ...
            // // optional : after searching for the user just empty the user value which means empty the search bar
            // setUser('')
        }
    }
